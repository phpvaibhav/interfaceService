...
class Service_model extends CI_Model {
    ...
    var $table = 'service';
    var $column_order = array('s.serviceId','s.productName','s.vendor','s.modelName','s.serialNumber','s.purchaseDate','s.contactNumber','s.faultdescription','s.status'); //set column field database for datatable orderable
    var $column_sel = array('s.serviceId','s.productName','s.vendor','s.serialNumber','s.modelName','s.purchaseDate','s.contactNumber','s.faultdescription','s.status','(case when (s.status = 0) 
